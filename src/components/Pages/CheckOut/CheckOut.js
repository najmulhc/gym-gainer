      ...
      <main className="container mx-auto grid grid-cols-1 md:grid-cols-2 md:my-12 mb-12 ">
        ...
        <div className="px-8 my-auto flex flex-col justify-start">
          ...
          <h3 className="text-grey font-mono text-2xl font-semibold text-left">${data.price}</h3>
            <p className="text-gray-800 font-normal text-md text-left mt-4 md:pr-20">{data.description}</p>
            <button className="text-white py-2 bg-komola px-6  mt-12 text-2xl w-full">
                <Link to="/" >
                  Save a spot 
                </Link>
              </button>
